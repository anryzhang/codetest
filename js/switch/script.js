//http://js.alixixi.com/demo/rotating-slideshow/
	...
	if($.support.transform){
		...
		slideShow.bind('rotateContainer',function(e,direction){
			...
			slideShow.animate({
				...
				slideShow.animate({				
					rotate:Math.round($.rotate.radToDeg(slideShow.css('rotate'))) + 'deg'
				},'slow').animate({
					width		: 490,
					height		: 490
				},'fast');
		...
		slideShow.bind('showNext',function(){
			slideShow.trigger('rotateContainer');
		});
